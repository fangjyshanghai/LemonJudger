...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        OptionsDialog->resize(291, 377);
        OptionsDialog->setMinimumSize(QSize(291, 377));
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(generalSettings), QApplication::translate("OptionsDialog", "General", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(compilerSettings), QApplication::translate("OptionsDialog", "Compiler", Q_NULLPTR));
    } // retranslateUi
