...
public:
    ...
    void setupUi(QWidget *GeneralSettings)
    {
        ...
        GeneralSettings->resize(302, 334);
        ...
        label->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        defaultFullScore->setMinimumSize(QSize(81, 0));
        defaultFullScore->setMaximumSize(QSize(81, 16777215));
        ...
        label_2->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        defaultTimeLimit->setMinimumSize(QSize(81, 0));
        defaultTimeLimit->setMaximumSize(QSize(81, 16777215));
        ...
        label_6->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        label_3->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        defaultMemoryLimit->setMinimumSize(QSize(81, 0));
        defaultMemoryLimit->setMaximumSize(QSize(81, 16777215));
        ...
        label_7->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        label_4->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        compileTimeLimit->setMinimumSize(QSize(81, 0));
        compileTimeLimit->setMaximumSize(QSize(81, 16777215));
        ...
        label_8->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        label_17->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        specialJudgeTimeLimit->setMinimumSize(QSize(81, 0));
        specialJudgeTimeLimit->setMaximumSize(QSize(81, 16777215));
        ...
        label_18->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        label_5->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        fileSizeLimit->setMinimumSize(QSize(81, 0));
        fileSizeLimit->setMaximumSize(QSize(81, 16777215));
        ...
        label_9->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        label_19->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        numberOfThreads->setMinimumSize(QSize(81, 0));
        numberOfThreads->setMaximumSize(QSize(81, 16777215));
        ...
        label_10->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        label_12->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        label_11->setStyleSheet(QStringLiteral("font-size:9pt;"));
    ...
    {
        GeneralSettings->setWindowTitle(QApplication::translate("GeneralSettings", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("GeneralSettings", "Default Full Score", Q_NULLPTR));
        label_2->setText(QApplication::translate("GeneralSettings", "Default Time Limit", Q_NULLPTR));
        label_6->setText(QApplication::translate("GeneralSettings", "ms", Q_NULLPTR));
        label_3->setText(QApplication::translate("GeneralSettings", "Default Memory Limit", Q_NULLPTR));
        label_7->setText(QApplication::translate("GeneralSettings", "MB", Q_NULLPTR));
        label_4->setText(QApplication::translate("GeneralSettings", "Compile Time Limit", Q_NULLPTR));
        label_8->setText(QApplication::translate("GeneralSettings", "ms", Q_NULLPTR));
        label_17->setText(QApplication::translate("GeneralSettings", "Special Judge Time Limit", Q_NULLPTR));
        label_18->setText(QApplication::translate("GeneralSettings", "ms", Q_NULLPTR));
        label_5->setText(QApplication::translate("GeneralSettings", "Source File Size Limit", Q_NULLPTR));
        label_9->setText(QApplication::translate("GeneralSettings", "KB", Q_NULLPTR));
        label_19->setText(QApplication::translate("GeneralSettings", "Number of Threads", Q_NULLPTR));
        label_10->setText(QApplication::translate("GeneralSettings", "Input File Extensions", Q_NULLPTR));
        label_12->setText(QApplication::translate("GeneralSettings", "Output File Extensions", Q_NULLPTR));
        label_11->setText(QApplication::translate("GeneralSettings", "(separated by \";\". Empty means no limitation.)", Q_NULLPTR));
    } // retranslateUi
