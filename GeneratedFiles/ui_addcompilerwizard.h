...
public:
    ...
    void setupUi(QWizard *AddCompilerWizard)
    {
        ...
        AddCompilerWizard->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        stepOneLabel->setStyleSheet(QStringLiteral("font-size:10pt;font-weight:bold;"));
        ...
        customRadioButton->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        builtinRadioButton->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        gccCheck->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        gppCheck->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        fpcCheck->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        fbcCheck->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        jdkCheck->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        pythonCheck->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        stepTwoLabel->setStyleSheet(QStringLiteral("font-size:10pt;font-weight:bold;"));
        ...
        compilerNameLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        compilerName->setMinimumSize(QSize(61, 20));
        compilerName->setMaximumSize(QSize(150, 20));
        compilerName->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        compilerTypeLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        typeSelect->setMinimumSize(QSize(211, 20));
        typeSelect->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        compilerLocationLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        compilerLocation->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        interpreterLocationLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        interpreterLocation->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        sourceFileExtensionsLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        sourceFileExtensions->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        bytecodeFileExtensionsLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        bytecodeFileExtensions->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        defaultCompilerArgumentsLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        defaultCompilerArguments->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        defaultInterpreterArgumentsLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        defaultInterpreterArguments->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        stepTwoLabel_2->setStyleSheet(QStringLiteral("font-size:10pt;font-weight:bold;"));
        ...
        gccGroupBox->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        gccO2Check->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        gppGroupBox->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        gppO2Check->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        fpcGroupBox->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        fpcO2Check->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        fbcGroupBox->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        javaGroupBox->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        label->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        label_2->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        javaMemoryLimitLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        javaMbLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        pythonGroupBox->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        pythonBytecodeCheck = new QCheckBox(pythonGroupBox);
        pythonBytecodeCheck->setObjectName(QStringLiteral("pythonBytecodeCheck"));
        pythonBytecodeCheck->setStyleSheet(QStringLiteral("font-size:9pt;"));

        verticalLayout_11->addWidget(pythonBytecodeCheck);
        ...
        stepThreeLabel->setStyleSheet(QStringLiteral("font-size:10pt;font-weight:bold;"));
        ...
        logViewer->setStyleSheet(QStringLiteral("font-size:10pt;"));
    ...
    {
        AddCompilerWizard->setWindowTitle(QApplication::translate("AddCompilerWizard", "Add Compilers Wizard", Q_NULLPTR));
        stepOneLabel->setText(QApplication::translate("AddCompilerWizard", "Step I: Choose whether you want to use built-in configuration for certain compilers or customize a compiler's configuration.", Q_NULLPTR));
        customRadioButton->setText(QApplication::translate("AddCompilerWizard", "Custom Configuration", Q_NULLPTR));
        builtinRadioButton->setText(QApplication::translate("AddCompilerWizard", "Built-in Configuration (Tick the compilers you want to add)", Q_NULLPTR));
        stepTwoLabel->setText(QApplication::translate("AddCompilerWizard", "Step II: Select compiler's location to configure it.", Q_NULLPTR));
        compilerNameLabel->setText(QApplication::translate("AddCompilerWizard", "Compiler Name", Q_NULLPTR));
        compilerTypeLabel->setText(QApplication::translate("AddCompilerWizard", "Compiler Type", Q_NULLPTR));
        typeSelect->clear();
        typeSelect->insertItems(0, QStringList()
         << QApplication::translate("AddCompilerWizard", "Typical (Generate executable file)", Q_NULLPTR)
         << QApplication::translate("AddCompilerWizard", "Interpretive (Generate byte-code file)", Q_NULLPTR)
         << QApplication::translate("AddCompilerWizard", "Interpretive (Run source code directly)", Q_NULLPTR)
        );
        compilerLocationLabel->setText(QApplication::translate("AddCompilerWizard", "Compiler's Location", Q_NULLPTR));
        interpreterLocationLabel->setText(QApplication::translate("AddCompilerWizard", "Interpreter's Location", Q_NULLPTR));
        sourceFileExtensionsLabel->setText(QApplication::translate("AddCompilerWizard", "Source File Extensions", Q_NULLPTR));
        bytecodeFileExtensionsLabel->setText(QApplication::translate("AddCompilerWizard", "Byte-code File Extensions", Q_NULLPTR));
        defaultCompilerArgumentsLabel->setText(QApplication::translate("AddCompilerWizard", "Default Compiler's Arguments", Q_NULLPTR));
        defaultInterpreterArgumentsLabel->setText(QApplication::translate("AddCompilerWizard", "Default Interpreter's Arguments", Q_NULLPTR));
        stepTwoLabel_2->setText(QApplication::translate("AddCompilerWizard", "Step II: Select compilers' locations to configure them.", Q_NULLPTR));
        gccO2Check->setText(QApplication::translate("AddCompilerWizard", "Enable O2 Optimization", Q_NULLPTR));
        gppO2Check->setText(QApplication::translate("AddCompilerWizard", "Enable O2 Optimization", Q_NULLPTR));
        fpcO2Check->setText(QApplication::translate("AddCompilerWizard", "Enable O2 Optimization", Q_NULLPTR));
        javaMemoryLimitLabel->setText(QApplication::translate("AddCompilerWizard", "Memory Limit", Q_NULLPTR));
        javaMbLabel->setText(QApplication::translate("AddCompilerWizard", "MB", Q_NULLPTR));
        pythonBytecodeCheck->setText(QApplication::translate("AddCompilerWizard", "Generate Optimized Byte-code", Q_NULLPTR));
        stepThreeLabel->setText(QApplication::translate("AddCompilerWizard", "Step III: Check the result and finish the wizard.", Q_NULLPTR));
    } // retranslateUi
