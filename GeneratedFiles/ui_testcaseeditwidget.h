...
public:
    ...
    void setupUi(QWidget *TestCaseEditWidget)
    {
        ...
        fileList->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        inputFileLabel->setStyleSheet(QStringLiteral("font-size: 8pt;"));
        ...
        outputFileLabel->setStyleSheet(QStringLiteral("font-size: 8pt;"));
        ...
        fullScoreLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        timeLimitLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        memoryLimitLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
    ...
    {
        TestCaseEditWidget->setWindowTitle(QApplication::translate("TestCaseEditWidget", "Form", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = fileList->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("TestCaseEditWidget", "Input Files", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = fileList->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("TestCaseEditWidget", "Output Files", Q_NULLPTR));
        inputFileLabel->setText(QApplication::translate("TestCaseEditWidget", "Input File Name", Q_NULLPTR));
        outputFileLabel->setText(QApplication::translate("TestCaseEditWidget", "Output File Name", Q_NULLPTR));
        addButton->setText(QApplication::translate("TestCaseEditWidget", "&Add", Q_NULLPTR));
        fullScoreLabel->setText(QApplication::translate("TestCaseEditWidget", "Full Score", Q_NULLPTR));
        timeLimitLabel->setText(QApplication::translate("TestCaseEditWidget", "Time Limit", Q_NULLPTR));
        msLabel->setText(QApplication::translate("TestCaseEditWidget", "ms", Q_NULLPTR));
        memoryLimitLabel->setText(QApplication::translate("TestCaseEditWidget", "Memory Limit", Q_NULLPTR));
        mbLabel->setText(QApplication::translate("TestCaseEditWidget", "MB", Q_NULLPTR));
    } // retranslateUi
