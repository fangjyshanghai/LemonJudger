...
public:
    ...
    void setupUi(QWizard *AddTestCasesWizard)
    {
        ...
        AddTestCasesWizard->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        fullScoreLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        timeLimitLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        msLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        memoryLimitLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        mbLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        inputFilesPatternLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        inputFilesPattern->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        outputFilesPatternLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        outputFilesPattern->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        argumentList->setStyleSheet(QStringLiteral("font-size: 9pt;"));
    ...
    {
        AddTestCasesWizard->setWindowTitle(QApplication::translate("AddTestCasesWizard", "Add Test Cases", Q_NULLPTR));
        stepOneLabel->setText(QApplication::translate("AddTestCasesWizard", "Step I: Input the full score, time limit and memory limit for each new test case.", Q_NULLPTR));
        fullScoreLabel->setText(QApplication::translate("AddTestCasesWizard", "Full Score", Q_NULLPTR));
        timeLimitLabel->setText(QApplication::translate("AddTestCasesWizard", "Time Limit", Q_NULLPTR));
        msLabel->setText(QApplication::translate("AddTestCasesWizard", "ms", Q_NULLPTR));
        memoryLimitLabel->setText(QApplication::translate("AddTestCasesWizard", "Memory Limit", Q_NULLPTR));
        mbLabel->setText(QApplication::translate("AddTestCasesWizard", "MB", Q_NULLPTR));
        stepTwoLabel->setText(QApplication::translate("AddTestCasesWizard", "Step II: Input patterns for input files and output files. You can use argument <1>, <2>, etc. to represent a regular expression. Input and output files will in the same test case when their matched parts of checked expressions are identical.", Q_NULLPTR));
        inputFilesPatternLabel->setText(QApplication::translate("AddTestCasesWizard", "Input Files Pattern", Q_NULLPTR));
        outputFilesPatternLabel->setText(QApplication::translate("AddTestCasesWizard", "Output Files Pattern", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = argumentList->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("AddTestCasesWizard", "Argument", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = argumentList->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("AddTestCasesWizard", "Regular Expression", Q_NULLPTR));
        addArgumentButton->setText(QString());
        deleteArgumentButton->setText(QString());
        stepThreeLabel->setText(QApplication::translate("AddTestCasesWizard", "Step III: Preview the result and finish the wizard.", Q_NULLPTR));
    } // retranslateUi
