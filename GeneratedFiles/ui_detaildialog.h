...
public:
    ...
    {
        DetailDialog->setWindowTitle(QApplication::translate("DetailDialog", "Details", Q_NULLPTR));
        closeButton->setText(QApplication::translate("DetailDialog", "&Close", Q_NULLPTR));
    } // retranslateUi
