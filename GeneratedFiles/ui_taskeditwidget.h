...
public:
    ...
    void setupUi(QWidget *TaskEditWidget)
    {
        ...
        problemTitleLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        taskTypeLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        traditionalButton->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        answersOnlyButton->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        sourceFileNameLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        inputFileNameLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight: bold;"));
        ...
        standardInputCheck->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        outputFileNameLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        standardOutputCheck->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        comparisonModeLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        comparisonMode->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        argumentsLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        precisionLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        digitsLabel->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        compilerSettingsLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        configurationLabel->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        configurationSelect->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        answerFileExtensionLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
    ...
    {
        TaskEditWidget->setWindowTitle(QApplication::translate("TaskEditWidget", "Form", Q_NULLPTR));
        problemTitleLabel->setText(QApplication::translate("TaskEditWidget", "Problem Title", Q_NULLPTR));
        taskTypeLabel->setText(QApplication::translate("TaskEditWidget", "Task Type", Q_NULLPTR));
        traditionalButton->setText(QApplication::translate("TaskEditWidget", "Traditional", Q_NULLPTR));
        answersOnlyButton->setText(QApplication::translate("TaskEditWidget", "Answers Only", Q_NULLPTR));
        sourceFileNameLabel->setText(QApplication::translate("TaskEditWidget", "Source File Name", Q_NULLPTR));
        inputFileNameLabel->setText(QApplication::translate("TaskEditWidget", "Input File Name", Q_NULLPTR));
        standardInputCheck->setText(QApplication::translate("TaskEditWidget", "Standard input", Q_NULLPTR));
        outputFileNameLabel->setText(QApplication::translate("TaskEditWidget", "Output File Name", Q_NULLPTR));
        standardOutputCheck->setText(QApplication::translate("TaskEditWidget", "Standard output", Q_NULLPTR));
        comparisonModeLabel->setText(QApplication::translate("TaskEditWidget", "Comparison Mode", Q_NULLPTR));
        comparisonMode->clear();
        comparisonMode->insertItems(0, QStringList()
         << QApplication::translate("TaskEditWidget", "Line-by-line mode", Q_NULLPTR)
         << QApplication::translate("TaskEditWidget", "Line-by-line mode (ignore extra spaces and tabs)", Q_NULLPTR)
         << QApplication::translate("TaskEditWidget", "External tool mode (diff)", Q_NULLPTR)
         << QApplication::translate("TaskEditWidget", "Real number mode", Q_NULLPTR)
         << QApplication::translate("TaskEditWidget", "Special judge mode", Q_NULLPTR)
        );
        argumentsLabel->setText(QApplication::translate("TaskEditWidget", "Arguments:", Q_NULLPTR));
        precisionLabel->setText(QApplication::translate("TaskEditWidget", "Real Number Precision:", Q_NULLPTR));
        digitsLabel->setText(QApplication::translate("TaskEditWidget", "digits", Q_NULLPTR));
        compilerSettingsLabel->setText(QApplication::translate("TaskEditWidget", "Compiler Settings", Q_NULLPTR));
        configurationLabel->setText(QApplication::translate("TaskEditWidget", "Configuration:", Q_NULLPTR));
        answerFileExtensionLabel->setText(QApplication::translate("TaskEditWidget", "Extension of Contestant's Answer File", Q_NULLPTR));
    } // retranslateUi
