...
public:
    ...
    void setupUi(QDialog *AdvancedCompilerSettingsDialog)
    {
        ...
        AdvancedCompilerSettingsDialog->resize(318, 461);
        AdvancedCompilerSettingsDialog->setMinimumSize(QSize(318, 461));
        ...
        locationGroup->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        compilerLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        interpreterLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        bytecodeExtensionLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        bytecodeExtension->setMaximumSize(QSize(50, 20));
        ...
        limitGroup->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        timeLimitRationLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        memoryLimitRatioLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        disableMemoryLimit->setStyleSheet(QStringLiteral("font-size:8pt;"));
        ...
        argumentsGroup->setStyleSheet(QStringLiteral("font-size:9pt;"));
        ...
        configurationLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        deleteConfigurationButton->setMinimumSize(QSize(23, 23));
        QIcon icon;
        ...
        compilerArgumentsLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        interpreterArgumentsLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
    ...
    {
        AdvancedCompilerSettingsDialog->setWindowTitle(QApplication::translate("AdvancedCompilerSettingsDialog", "Compiler Settings", Q_NULLPTR));
        typeSelect->clear();
        typeSelect->insertItems(0, QStringList()
         << QApplication::translate("AdvancedCompilerSettingsDialog", "Typical (Generate executable file)", Q_NULLPTR)
         << QApplication::translate("AdvancedCompilerSettingsDialog", "Interpretive (Generate byte-code file)", Q_NULLPTR)
         << QApplication::translate("AdvancedCompilerSettingsDialog", "Interpretive (Run source code directly)", Q_NULLPTR)
        );
        locationGroup->setTitle(QApplication::translate("AdvancedCompilerSettingsDialog", "Location", Q_NULLPTR));
        compilerLabel->setText(QApplication::translate("AdvancedCompilerSettingsDialog", "Compiler", Q_NULLPTR));
        interpreterLabel->setText(QApplication::translate("AdvancedCompilerSettingsDialog", "Interpreter", Q_NULLPTR));
        bytecodeExtensionLabel->setText(QApplication::translate("AdvancedCompilerSettingsDialog", "Byte-code File Extensions", Q_NULLPTR));
        limitGroup->setTitle(QApplication::translate("AdvancedCompilerSettingsDialog", "Time and Memory Limit", Q_NULLPTR));
        timeLimitRationLabel->setText(QApplication::translate("AdvancedCompilerSettingsDialog", "Time Limit Ration", Q_NULLPTR));
        memoryLimitRatioLabel->setText(QApplication::translate("AdvancedCompilerSettingsDialog", "Memory Limit Ration", Q_NULLPTR));
        disableMemoryLimit->setText(QApplication::translate("AdvancedCompilerSettingsDialog", "Disable Memory Limit", Q_NULLPTR));
        argumentsGroup->setTitle(QApplication::translate("AdvancedCompilerSettingsDialog", "Arguments", Q_NULLPTR));
        configurationLabel->setText(QApplication::translate("AdvancedCompilerSettingsDialog", "Configuration", Q_NULLPTR));
        deleteConfigurationButton->setText(QApplication::translate("AdvancedCompilerSettingsDialog", "...", Q_NULLPTR));
        compilerArgumentsLabel->setText(QApplication::translate("AdvancedCompilerSettingsDialog", "Compiler's Arguments", Q_NULLPTR));
        interpreterArgumentsLabel->setText(QApplication::translate("AdvancedCompilerSettingsDialog", "Interpreter's Arguments", Q_NULLPTR));
        environmentVariablesButton->setText(QApplication::translate("AdvancedCompilerSettingsDialog", "Environment Variables", Q_NULLPTR));
    } // retranslateUi
