...
public:
    ...
    {
        WelcomeDialog->setWindowTitle(QApplication::translate("WelcomeDialog", "Welcome", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(openTab), QApplication::translate("WelcomeDialog", "Open", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(newTab), QApplication::translate("WelcomeDialog", "New", Q_NULLPTR));
    } // retranslateUi
