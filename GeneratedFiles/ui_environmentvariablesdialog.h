...
public:
    ...
    void setupUi(QDialog *EnvironmentVariablesDialog)
    {
        ...
        valueViewer->setStyleSheet(QStringLiteral("font-size: 9pt;"));
    ...
    {
        EnvironmentVariablesDialog->setWindowTitle(QApplication::translate("EnvironmentVariablesDialog", "Extra Environment Variables", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = valueViewer->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("EnvironmentVariablesDialog", "Variable", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = valueViewer->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("EnvironmentVariablesDialog", "Value", Q_NULLPTR));
        addButton->setText(QApplication::translate("EnvironmentVariablesDialog", "&Add", Q_NULLPTR));
        editButton->setText(QApplication::translate("EnvironmentVariablesDialog", "&Edit", Q_NULLPTR));
        deleteButton->setText(QApplication::translate("EnvironmentVariablesDialog", "&Delete", Q_NULLPTR));
    } // retranslateUi
