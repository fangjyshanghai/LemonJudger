...
public:
    ...
    void setupUi(QWidget *CompilerSettings)
    {
        ...
        CompilerSettings->resize(275, 327);
        ...
        compilerList->setStyleSheet(QStringLiteral("font-size: 9pt;"));
        ...
        compilerNameLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        sourceExtensionsLabel->setStyleSheet(QStringLiteral("font-size:9pt;font-weight:bold;"));
        ...
        sourceExtensions->setStyleSheet(QStringLiteral("font-size:9pt;"));
    ...
    {
        CompilerSettings->setWindowTitle(QApplication::translate("CompilerSettings", "Form", Q_NULLPTR));
        ...
        compilerNameLabel->setText(QApplication::translate("CompilerSettings", "Compiler Name", Q_NULLPTR));
        sourceExtensionsLabel->setText(QApplication::translate("CompilerSettings", "Source Extensions", Q_NULLPTR));
        advancedButton->setText(QApplication::translate("CompilerSettings", "&Advanced", Q_NULLPTR));
    } // retranslateUi
