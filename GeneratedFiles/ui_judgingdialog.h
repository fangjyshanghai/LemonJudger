...
public:
    ...
    {
        JudgingDialog->setWindowTitle(QApplication::translate("JudgingDialog", "Judging", Q_NULLPTR));
        cancelButton->setText(QApplication::translate("JudgingDialog", "Cancel", Q_NULLPTR));
    } // retranslateUi
