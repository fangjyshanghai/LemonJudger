...
public:
    ...
    void setupUi(QWidget *NewContestWidget)
    {
        ...
        label->setStyleSheet(QStringLiteral("font-size:10pt;font-weight:bold;"));
        ...
        label_2->setStyleSheet(QStringLiteral("font-size:10pt;font-weight:bold;"));
        ...
        label_3->setStyleSheet(QStringLiteral("font-size:10pt;font-weight:bold;"));
    ...
    {
        NewContestWidget->setWindowTitle(QApplication::translate("NewContestWidget", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("NewContestWidget", "Contest Title", Q_NULLPTR));
        label_2->setText(QApplication::translate("NewContestWidget", "Saving Name", Q_NULLPTR));
        label_3->setText(QApplication::translate("NewContestWidget", "Contest Path", Q_NULLPTR));
    } // retranslateUi
